      ...
      {hasResults && (
        <div className="bg-white rounded-2xl shadow-sm border border-gray-100 p-4 flex flex-wrap gap-2 items-center">
          ...
          <button
            ...
            className="px-4 py-1.5 text-sm bg-green-50 hover:bg-green-100 disabled:opacity-60 text-green-700 rounded-lg font-medium transition flex items-center gap-1.5"
          >
            {sheets.loading ? (
              <>
          ...
          {sheets.result && (
            <a
              ...
              title={sheets.result.title}
              className="px-4 py-1.5 text-sm bg-green-600 text-white rounded-lg font-medium hover:bg-green-700 transition flex items-center gap-1"
            >
              ✓ シートを開く →
            </a>
          )}
          ...
          {sheets.error && (
            <span className="text-xs text-red-500 max-w-xs">{sheets.error}</span>
          )}
        </div>
      )}
